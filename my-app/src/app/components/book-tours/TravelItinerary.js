    ...
    <section className="p-6 rounded-lg shadow-lg max-w-3xl mx-auto mt-8 bg-white">
      ...
      <section className="flex flex-col space-y-4">
        {Object.entries(itineraries).map(([key, itinerary]) => (
          <section key={key} className="border-b border-gray-300 pb-4">
            {/* Radio Button */}
            ...
            >
              <section className="mt-4 p-10 rounded-lg shadow-inner">
                <Image
                  src={itinerary.image}
                  alt={itinerary.title}
                ...
                <section className="flex items-center justify-center text-gray-800 mt-2">
