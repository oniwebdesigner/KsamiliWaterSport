...
const TourDetails = ({ price, MaxCapacity, hours }) => {
  return (
    <div className="bg-gray-50 p-4 shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0 md:justify-between items-start md:items-center">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start space-x-4 space-y-2 md:space-y-0">
